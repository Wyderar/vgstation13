...
/client/AllowUpload(filename, filelength)
	if(filelength > UPLOAD_LIMIT)
		to_chat(src, "<font color='red'>Error: AllowUpload(): File Upload too large. Upload Limit: [UPLOAD_LIMIT/5120]KiB.</font>")
		return 0
...
/client/New(TopicData)
	...
	if(custom_event_msg && custom_event_msg != "")
		...
		to_chat(src, "<span class='alert'>[to_utf8(custom_event_msg)]</span>")
		to_chat(src, "<br>")
